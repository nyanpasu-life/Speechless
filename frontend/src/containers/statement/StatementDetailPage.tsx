			...
			<div className='content-header mb-10'>
				...
				<div className='flex justify-between items-center'>
					...
					<div className='flex gap-3'>
						<CustomButton bordered color='white' onClick={() => { navigate('/statement/write/' + id); }}>
			...
			<Card className='2xl:w-3/4 xl:w-4/5 w-full mx-auto p-10'>
				<div className='flex flex-col space-y-10'>
					...
					<div className='bg-gray-50 border-2 border-gray-200 rounded-md p-10 flex flex-col space-y-6'>
						...
						<span
							className='flex items-center justify-center gap-2 p-2 rounded-full bg-white w-fit mx-auto border-2'>
							<button className='material-symbols-outlined' onClick={decreaseCursor}>chevron_left</button>
							<span
								className='text-sm tracking-widest'>{questionCursor} / {formData.questions.length}</span>
							<button className='material-symbols-outlined'
									onClick={increaseCursor}>chevron_right</button>
						</span>
