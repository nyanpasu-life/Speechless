		...
		<>
			<div className='content-header mb-10'>
				<Breadcrumb className='pb-8'>
					...
					<BreadcrumbItem>발표 그룹 모집</BreadcrumbItem>
				</Breadcrumb>
				...
				<div className='flex flex-col space-y-10'>
					<div className='flex justify-between items-center gap-10'>
						...
						<div className='flex items-center gap-3'>
							...
							) : moment.duration(moment(speechDetail.deadline).diff(moment())).asSeconds() < 0 ? (
								<CustomButton color='white' bordered>
									종료된 모집입니다.
								</CustomButton>
							) : (
								<CustomButton color='positive' bordered onClick={joinGroup}>
									<div className='flex items-center gap-2'>
					...
					<div className='flex items-center gap-8'>
						...
						<span className='flex items-center gap-3'>
							...
							<span className='font-semibold'>
								{speechDetail.currentParticipants ? speechDetail.currentParticipants : 0} /{' '}
					...
					<div className='flex justify-end gap-5 pt-10'>
						{speechDetail.isParticipated && !isOwner ? (
							<CustomButton bordered color='negative' onClick={deleteGroup}>
								<div className='flex items-center gap-2'>
						...
						{isOwner ? (
							<>
								<CustomButton bordered color='white' onClick={updateSpeech}>
									<div className='flex items-center gap-2'>
										<span className='material-symbols-outlined text-sm'>edit</span>
										<span>모집 글 수정</span>
									</div>
								</CustomButton>
								<CustomButton bordered color='negative' onClick={deleteSpeech}>
									<div className='flex items-center gap-2'>
